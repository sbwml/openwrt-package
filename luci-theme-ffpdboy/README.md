...
<a href="#readme">
    <img src="https://img.vim-cn.com/7f/270400123d9c4385c11d0aed32979f35d80578.png" alt="图飞了😂" title="ffpdboy" align="right" height="180" />
</a>
欢迎来到sirpdboy的源码仓库！
=
Welcome to sirpdboy's  git source of packages
-
[luci-theme-ffpdboy  thme openwrt主题](https://github.com/sirpdboy/luci-theme-ffpdboy)
-
...
ffpdboy是一款基于luci-theme-material构建,使用HTML5、CSS3编写的Luci主题。
-
...
将ffpdboy 主题添加至 LEDE/OpenWRT 源码的方法。
...
```Brach
    # feeds获取源码：
    src-git ffpdboy  https://github.com/sirpdboy/luci-theme-ffpdboy
 ``` 
  ```Brach
   # 更新feeds，并安装主题：
    scripts/feeds update ffpdboy
	scripts/feeds install luci-theme-ffpdboy
 ``` 	
...
## 下载源码方法二：
 ```Brach
    ...
    git clone https://github.com/sirpdboy/luci-theme-ffpdboy package/luci-theme-ffpdboy
...
## 配置菜单
 ```Brach
    make menuconfig
	# 找到 LuCI -> Themes, 选择 luci-theme-ffpdboy, 保存后退出。
 ``` 
## 编译
 ```Brach 
    # 编译固件
    make package/luci-app-ffpdboy/{clean,compile} V=s
 ```
![xm1](doc/登陆页面.jpg)
![xm2](doc/实时监控.jpg)
![xm3](doc/手机画面.jpg)
...
源码来源：https://github.com/sirpdboy/luci-theme-ffpdboy
...
ffpdboy主题 : https://github.com/sirpdboy/luci-theme-ffpdboy
