...
local custom_domain = read_conf("/etc/cssr/custom_domain.list")
local custom_ip = read_conf("/etc/cssr/custom_ip.list")

local youtube_domain = read_conf("/etc/cssr/youtube_domain.list")
local youtube_ip = read_conf("/etc/cssr/youtube_ip.list")

local tw_video_domain = read_conf("/etc/cssr/tw_video_domain.list")
local tw_video_ip = read_conf("/etc/cssr/tw_video_ip.list")

local netflix_domain = read_conf("/etc/cssr/netflix_domain.list")
local netflix_ip = read_conf("/etc/cssr/netflix_ip.list")

local disney_domain = read_conf("/etc/cssr/disney_domain.list")
local disney_ip = read_conf("/etc/cssr/disney_ip.list")

local prime_domain = read_conf("/etc/cssr/prime_domain.list")
local prime_ip = read_conf("/etc/cssr/prime_ip.list")

local tvb_domain = read_conf("/etc/cssr/tvb_domain.list")
local tvb_ip = read_conf("/etc/cssr/tvb_ip.list")
