...
m = Map(cssr, translate('Edit cssr Server'))
m.redirect = luci.dispatcher.build_url('admin/services/cssr/servers')
if m.uci:get(cssr, sid) ~= 'servers' then
...
if nixio.fs.access('/usr/bin/csocks') then
