...
local m,s,o
local white_f=string.format("/etc/bypass/white.list")
local main_f=string.format("/etc/bypass/black.list")
local yb_f=string.format("/etc/bypass/youtube.list")
local nf_f=string.format("/etc/bypass/netflix.list")
local cu_f=string.format("/etc/bypass/custom.list")
local ov_f=string.format("/etc/bypass/oversea.list")
local pre_f=string.format("/etc/bypass/preload.list")

m=Map("bypass",translate("Domain List"))
s=m:section(TypedSection,"global")
s.anonymous=true

m.apply_on_parse=true
function m.on_apply(self)
	luci.sys.exec("/etc/init.d/bypass reload &")
end
