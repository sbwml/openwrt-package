...
m = Map("ssrpro", translate("Edit Ssrpro Server"))
m.redirect = luci.dispatcher.build_url("admin/services/ssrpro/servers")
if m.uci:get("ssrpro", sid) ~= "servers" then
...
o = s:option(DummyValue, "ssr_url", "URL")
o.rawhtml = true
o.template = "ssrpro/ssrurl"
o.value = sid
...
if is_finded('csocks') then
    o:value('csocks', translate('cSocks'))
end
...
o = s:option(Value, 'tls_ip', translate('tls_ip'))
o:depends('type', 'csocks')
o.rmempty = true

o = s:option(Value, 'out_addr', translate('out_addr'))
o:depends('type', 'csocks')
o.rmempty = true
