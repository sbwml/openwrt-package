...
local escconf = "/etc/ssrpro/white.list"
...
local blockconf = "/etc/ssrpro/black.list"
...
local denydomainconf = "/etc/ssrpro/deny.list"
...
local netflixconf = "/etc/ssrpro/netflix.list"
